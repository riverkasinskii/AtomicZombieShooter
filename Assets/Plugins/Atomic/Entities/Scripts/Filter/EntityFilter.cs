...
namespace Atomic.Entities
{
    public class EntityFilter : IEntityFilter
    {
        ...
        private void OnValueDeleted(IEntity entity, int key, object value) => this.Synchronize(entity);
        private void OnValueAdded(IEntity entity, int key, object value) => this.Synchronize(entity);
        private void OnValueChanged(IEntity entity, int key, object value) => this.Synchronize(entity);
